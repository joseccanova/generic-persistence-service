...
public class IndexedPropertyDescriptor extends PropertyDescriptor {
    ...
    public IndexedPropertyDescriptor(PropertyDescriptor x, PropertyDescriptor y) {
        super(x,y);
        Method tr = null;
        Method tw = null;
     ...
     */
    public IndexedPropertyDescriptor(IndexedPropertyDescriptor old) {
        super(old);
    ...
    public void updateGenericsFor(Class<?> type) {
