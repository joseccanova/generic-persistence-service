...
public class EventSetDescriptor extends FeatureDescriptor {
    ...
    public EventSetDescriptor(String base, EventSetInfo eventSetInfo, Method... methods) {
        ...
        setRemoveListenerMethod(eventSetInfo.getRemoveMethod());
        setGetListenerMethod(eventSetInfo.getGetMethod());
        setListenerType(eventSetInfo.getListenerType());
        setUnicast(eventSetInfo.isUnicast());
    }
     ...
     */
    public EventSetDescriptor(EventSetDescriptor x, EventSetDescriptor y) {
        super(x,y);
     ...
     */
    public EventSetDescriptor(EventSetDescriptor old) {
        super(old);
